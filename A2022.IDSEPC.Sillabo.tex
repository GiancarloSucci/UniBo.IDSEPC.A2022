...
\noindent Il corso non richiede alcun prerequisito specifico, a parte la conoscenza dei fondamenti di logica e familiarit\`{a} con problemi che possono essere risolti in modo automatico.
...
\midrule
    \endhead
	\centering\textbf{1} &   \argomento[Presentazione del corso e introduzione alla natura del processo computazionale]  \\
	& \materialedidattico[Lucidi presentati dal docente] \\
	\hline    
	\centering\textbf{2} &   \argomento[Struttura dei calcolatori]  \\
	& \materialedidattico \\
	\hline    
	\textbf{3} &   \argomento[Sistemi Operativi e Reti]  \\
	& \materialedidattico \\
	\hline    
	\textbf{4} &   \argomento[Linguaggi di Programmazione]  \\
	& \materialedidattico \\
	\hline    
	\textbf{5} &   \argomento[Processo di Produzione]  \\
	& \materialedidattico \\
	\hline    
	\textbf{6} &   \argomento[LaTex]  \\
	& \materialedidattico \\
	\hline    
	\textbf{7} &   \argomento[La scrittura di documenti in LaTex come paradigma della produzione digitale]  \\
	& \materialedidattico \\
	\hline    
	\textbf{8} &   \argomento[Argomento]  \\
	& \materialedidattico \\
	\hline    
	\textbf{9} &   \argomento[Argomento]  \\
	& \materialedidattico \\
	\hline    
	\textbf{10} &   \argomento[Argomento]  \\
	& \materialedidattico \\
	\hline    
	\textbf{11} &   \argomento[Argomento]  \\
	& \materialedidattico \\
	\hline    
	\textbf{12} &   \argomento[Argomento]  \\
	& \materialedidattico \\
	\hline    
	\textbf{13} &   \argomento[Argomento]  \\
	& \materialedidattico \\
	\hline    
	\textbf{14} &   \argomento[Argomento]  \\
	& \materialedidattico \\
	\hline   
	\textbf{15} &   \argomento[Argomento]  \\
	& \materialedidattico \\
	\hline    
	\textbf{16} &   \argomento[Argomento]  \\
	& \materialedidattico \\
	\hline    
	\textbf{17} &   \argomento[Argomento]  \\
	& \materialedidattico \\
	\hline    
	\textbf{18} &   \argomento[Argomento]  \\
	& \materialedidattico \\
	\hline    
	\textbf{19} &   \argomento[Argomento]  \\
	& \materialedidattico \\
	\hline    
	\textbf{20} &   \argomento[Argomento]  \\
	& \materialedidattico \\
	\hline    
