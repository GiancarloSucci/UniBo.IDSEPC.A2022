...
\item Una volta completato l'esercizio,
\fbox{\href{\wlnewdoc{minimale-esercizio-2-soluzione.tex}}{%
cliccare qui per vedere la soluzione}}.
\end{itemize}
\end{frame}
...
\begin{itemize}{\small
\item Semplicemente basta usare il comando \cmdbs{section},  \cmdbs{subsection} e \cmdbs{subsubsection}.
