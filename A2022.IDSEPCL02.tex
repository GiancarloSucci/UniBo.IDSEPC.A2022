...
\begin{frame}{Contributing through GitHub: Detailed Explanation}
  \includegraphics<1>[width=11.5cm]{UniBo.IDSEPC.A2022.LavoroCondiviso/pull-request-0}
  \includegraphics<2>[width=11.5cm]{UniBo.IDSEPC.A2022.LavoroCondiviso/pull-request3-1}
  \includegraphics<3>[width=11.5cm]{UniBo.IDSEPC.A2022.LavoroCondiviso/pull-request3-2}
  \includegraphics<4>[width=11.5cm]{UniBo.IDSEPC.A2022.LavoroCondiviso/pull-request3-3}
  \includegraphics<5>[width=11.5cm]{UniBo.IDSEPC.A2022.LavoroCondiviso/pull-request3-4}
  \includegraphics<6>[width=11.5cm]{UniBo.IDSEPC.A2022.LavoroCondiviso/pull-request3-5}
  \includegraphics<7>[width=11.5cm]{UniBo.IDSEPC.A2022.LavoroCondiviso/pull-request-4}
  \includegraphics<8>[width=11.5cm]{UniBo.IDSEPC.A2022.LavoroCondiviso/pull-request-5}
  \begin{center}
